...
public class ConfigurationDocument extends AcceleratorDocument {
	...
	public void showDocument() {
		...
		if ( requestConnectionIfNeeded() ) {
			fetchChannelGroups();//fetch the channel groups from the database 
		}
		else {
			closeDocument();
		}
	...
	private boolean requestConnection() {
		final ConnectionDictionary dictionary = ConnectionDictionary.getPreferredInstance( "test" );//src personal
