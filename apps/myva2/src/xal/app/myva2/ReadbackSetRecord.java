...
public class ReadbackSetRecord {
	...
	/** update readback from the virtual magnet soft ioc
	 * @throws Exception */
	public void updateReadback() throws Exception {
		if ( READ_CHANNEL != null && SET_CHANNEL != null ) {
			_lastSetpoint= SET_CHANNEL.getValDbl();
			_lastReadback=READ_CHANNEL.getValDbl();
		}
	}
}
